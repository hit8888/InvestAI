...
const Suggestion = ({ question, onSuggestedQuestionOnClick, itemIndex, isQuestionInCycle = false }: IProps) => {
  ...
  return (
    <div
      ...
      className={cn(
        'ease-in-ou flex w-full cursor-pointer items-center gap-2 text-wrap rounded-full border-2 border-primary/60 bg-primary/80 px-2 py-1 transition-all duration-300 hover:bg-primary/90 focus:bg-primary',
        {
