...
const AgentMessage = (props: Props) => {
  ...
  useEffect(() => {
    ...
    resizeObserverRef.current = new ResizeObserver(handleScrollToActiveResponse);
    ...
    <div ref={containerRef} className="flex-1 space-y-4 overflow-y-auto bg-white p-4">
      ...
      <div className="space-y-2">
        {suggestedQuestions.map((question) => (
          <SuggestedQuestion key={question} question={question} handleOnClick={handleSuggestedQuestionOnClick} />
        ))}
      </div>
