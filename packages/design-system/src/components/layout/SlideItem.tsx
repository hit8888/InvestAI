...
const SlideItem = ({ icon, title, onClick }: IProps) => {
  ...
  return (
    <div
      className="flex h-full w-full scale-100 cursor-pointer flex-col items-center gap-8 rounded-xl border border-primary/25 bg-white p-4 text-center shadow-xl md:scale-95 lg:scale-90"
      onClick={handleClick}
    >
