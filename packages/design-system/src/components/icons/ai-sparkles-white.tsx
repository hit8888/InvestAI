...
const AiSparklesWhiteIcon = ({ className = '', width, height, viewBox, ...props }: Props) => {
  return (
    <svg
    ...
    >
      ...
      <g mask="url(#mask0_white_sparkles)">
        <circle cx="12.25" cy="12.9492" r="13.5" fill="#FFFFFF" />
        <g filter="url(#filter0_f_white_sparkles)">
          <circle cx="5.5" cy="6.19922" r="7.5" fill="#E8F4FF" />
        </g>
        <g filter="url(#filter1_f_white_sparkles)">
          <circle cx="19" cy="12.9492" r="7.5" fill="#D1EBFF" />
        </g>
        <g filter="url(#filter2_f_white_sparkles)">
          <circle cx="7.75" cy="21.9492" r="7.5" fill="#B8E2FF" />
        </g>
        <g filter="url(#filter3_f_white_sparkles)">
          <rect x="2" y="1" width="20" height="22" fill="url(#shimmerGradientWhite)" />
        </g>
      </g>
      <defs>
        <filter
          id="filter0_f_white_sparkles"
          x="-14"
          y="-13.3008"
          width="39"
          height="39"
        ...
        >
          ...
          <feGaussianBlur stdDeviation="6" result="effect1_foregroundBlur_white_sparkles" />
        </filter>
        <filter
          id="filter1_f_white_sparkles"
          x="-0.5"
          y="-6.55078"
          width="39"
          height="39"
        ...
        >
          <feFlood floodOpacity="0" result="BackgroundImageFix" />
          <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
          <feGaussianBlur stdDeviation="2" result="effect1_foregroundBlur_white_sparkles" />
        </filter>
        <linearGradient id="shimmerGradientWhite" x1="11" y1="1" x2="11" y2="23" gradientUnits="userSpaceOnUse">
          <stop stopColor="#A9A4FF" stopOpacity="0" />
          <stop offset="0.3" stopColor="#A9A4FF" stopOpacity="0.5" />
          <stop offset="0.4" stopColor="#A9A4FF" />
          <stop offset="0.6" stopColor="#A9A4FF" />
          <stop offset="0.7" stopColor="#A9A4FF" stopOpacity="0.5" />
          <stop offset="1" stopColor="#A9A4FF" stopOpacity="0" />
          <animateTransform
...
export default AiSparklesWhiteIcon;
