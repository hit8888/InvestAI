    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          "[&.weekend:not([aria-selected])]:text-gray-400"  // Weekend dates color
        ),
        day_range_start: "day-range-start rounded-l-lg bg-primary text-primary-foreground",
        day_range_end: "day-range-end rounded-r-lg bg-primary text-primary-foreground",
        day_selected:
        ...
        day_range_middle:
          "aria-selected:bg-accent bg-primary/10 text-primary aria-selected:text-accent-foreground",
        day_hidden: "invisible",
        ...classNames,
      }}
      components={{
        IconLeft: () => (
          <DatePreviousArrow color="rgb(var(--primary))" className="h-6 w-6" />
        ),
        IconRight: () => (
          <DateNextArrow color="rgb(var(--primary))" className="h-6 w-6" />
        ),
      }}
      modifiers={{
