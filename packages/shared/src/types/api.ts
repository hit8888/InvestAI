import { z } from 'zod';
import { ConfigPayloadSchema, ProspectPayloadSchema, ProspectResponseSchema } from '../network/schemas';

export type ConfigPayload = z.infer<typeof ConfigPayloadSchema>;

export type ProspectPayload = z.infer<typeof ProspectPayloadSchema>;
