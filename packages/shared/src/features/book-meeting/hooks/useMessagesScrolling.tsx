...
import { willMessageRenderHTML, messagesGroupedByResponseIdAndTimestamp } from '../../../utils/common';
import throttle from 'lodash/throttle';

interface UseMessagesScrollingProps {
  messages: Message[];
  viewType: ViewType;
  enableScrollToBottom: boolean;
}

interface UseMessagesScrollingReturn {
  // Refs
  ...
  messagesSortedByResponseIdAndTimestamp: Message[][];
}

export const useMessagesScrolling = ({
  messages,
  viewType,
  enableScrollToBottom,
}: UseMessagesScrollingProps): UseMessagesScrollingReturn => {
  // Refs
  ...
  useEffect(() => {
    ...
    if (
      lastMessage?.role === MessageRole.AI &&
