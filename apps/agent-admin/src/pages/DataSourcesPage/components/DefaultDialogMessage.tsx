...
import SourcesDefaultInfoIcon from '@breakout/design-system/components/icons/sources-default-info-icon';
  ...
  return (
    <div className="flex max-w-md flex-col items-center gap-2">
      <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gray-200 p-2.5">
        <SourcesDefaultInfoIcon className="text-gray-400" width="16" height="16" />
      </div>
