...
const Suggestion = ({ question, onSuggestedQuestionOnClick }: IProps) => {
  return (
    <button
      ...
      className="group flex items-center justify-center gap-1 rounded-full border-2 border-primary/10 bg-primary/10 p-2 text-primary transition-all duration-300 ease-in-out hover:bg-primary/80 hover:text-white"
    >
