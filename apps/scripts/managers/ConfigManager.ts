import { RESPONSIVE_SIZES, SENTRY_DSN } from "../lib/constants";
import type { Config, Constants } from "../lib/types";
...
export function ConfigManager(deviceType?: "DESKTOP" | "TABLET") {
  ...
  const getConfig = (): Config => {
    ...
    return {
      ...
      isStaging: scriptElement?.getAttribute("is-staging") === "true", // TODO: Move to env based solution
